...
<div id="bottom">
    <div id="copyright">
        <div class="quick">
            <ul>
                <li><input type="button" class="quickbd iphone" onclick="location.href='https://gitee.com/hua-ting-yixiao/cloud-diary.git'" /></li>
                <li><input type="button" class="quickbd android" onclick="location.href='https://gitee.com/hua-ting-yixiao/cloud-diary.git'" /></li>
                <li><input type="button" class="quickbd pc" onclick="location.href='https://gitee.com/hua-ting-yixiao/cloud-diary.git'" /></li>
                <div class="clr"></div>
            </ul>
            <div class="clr"></div>
        </div>
        <div class="text">
            Copyright © 2006-2026 关注：创易学习栈 All Rights Reserved
        </div>
    </div>
</div>
</body>
